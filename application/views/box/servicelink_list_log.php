												...
												<div class="border-bottom border-light">
													<div class="d-flex align-items-center p-2 border-left border-<?php echo $status_color;?> bw--3">
														...
														<div class="flex-fill text-truncate line-height-1">
															<a href="<?php echo base_url().'app/'.$log_lists['appid'].'/'.$log_lists['service_id'];?>" class="text-<?php echo $status_color;?>"><?php echo '['.$log_lists['status'] .'] '. $log_lists['statusdesc'];?></a>
															<a href="#!" class="fs--13 d-block text-white p--2">From <?php echo $log_lists['app_name'].' - ('.$log_lists['link_name'].') - '.$log_lists['ipaddress'];?></a>
